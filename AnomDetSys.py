...
from AnomDetc.anomalDetector import anomalDetector
...
class AnomDetSys:
    def __init__(self,file_path,limit,max_autoencoder_size=10,FM_grace_period=None,AD_grace_period=10000,learning_rate=0.1,hidden_ratio=0.75,):
        ...
        #init AnomDetector
        self.AnomDetector = anomalDetector(self.FE.get_num_features(), max_autoencoder_size, FM_grace_period, AD_grace_period, learning_rate, hidden_ratio)
